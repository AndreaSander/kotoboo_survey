...
#How to make the graph more informative??. Pivot wider and clarify repeated measures
...
```{r}
#Boxplots para correlaciones
#Maybe lm instead ? because we don;t really need the random effects right?

#how_often_internet ~ gender + country + (1|subject) ?? As it is I don't think caregivertype is really interesting parent vs. no parent predictor? ANOVA between lmM and see if adding parent helped or not.
