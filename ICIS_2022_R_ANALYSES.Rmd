...
# ---- kendall (cannot run on individual items?) ----
...
irr::kendall(data_feature_top %>% select(-feature), correct = FALSE)
...
irr::kendall(data_feature_bottom %>% select(-feature), correct = FALSE)
