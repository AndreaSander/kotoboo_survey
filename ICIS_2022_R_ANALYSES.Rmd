...
geom_bar(width = 1, stat = "identity") + geom_text(aes(label = percentage),
  ...
  scale_fill_manual(values=c("#e7a8a6", "#a7eb96"))+
  theme_bw()
...
geom_bar(width = 1, stat = "identity") +
  ...
  scale_fill_manual(values=c("#e7a8a6", "#a7eb96", "#ffb078"))+
  theme_bw()
...
geom_bar(width = 1, stat = "identity") +
  ...
  scale_fill_manual(values=c("#e7a8a6", "#a7eb96", "#ffb078","#b8cfec", "#b795d1"))+
  theme_bw()
...
```{r}
by_topic <- x_2022_june_qualtrics_data %>%
